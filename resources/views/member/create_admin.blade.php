...
<!--                             <option></option> -->
                            @foreach(Common::getNotAdmins() AS $v)
                     ...
                     <form action="{{ url('member/remove_admin') }}" method="POST" id="remove-encoder">
                     	{{ csrf_field() }}
